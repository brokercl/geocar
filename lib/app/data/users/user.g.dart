...
const UserSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'status': PropertySchema(
      ...
      name: r'status',
      type: IsarType.byte,
      enumMap: _UserstatusEnumValueMap,
    )
  },
  ...
  links: {
    r'userLinksMovil': LinkSchema(
      id: 7894320899942969167,
      name: r'userLinksMovil',
      target: r'Movil',
      single: false,
    )
  },
...
User _userDeserialize(
  ...
  final object = User(
    ...
    status: _UserstatusValueEnumMap[reader.readByteOrNull(offsets[2])] ??
        ObjectStatus.active,
  );
  return object;
}
...
P _userDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readStringOrNull(offset)) as P;
    case 2:
      return (_UserstatusValueEnumMap[reader.readByteOrNull(offset)] ??
...
List<IsarLinkBase<dynamic>> _userGetLinks(User object) {
  return [object.userLinksMovil];
}

void _userAttach(IsarCollection<dynamic> col, Id id, User object) {
  object.id = id;
  object.userLinksMovil
      .attach(col, col.isar.collection<Movil>(), r'userLinksMovil', id);
}
...
extension UserQueryLinks on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> userLinksMovil(
      FilterQuery<Movil> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'userLinksMovil');
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> userLinksMovilLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'userLinksMovil', length, true, length, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> userLinksMovilIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'userLinksMovil', 0, true, 0, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> userLinksMovilIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'userLinksMovil', 0, false, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> userLinksMovilLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'userLinksMovil', 0, true, length, include);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition>
      userLinksMovilLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'userLinksMovil', length, include, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> userLinksMovilLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'userLinksMovil', lower, includeLower, upper, includeUpper);
    });
  }
}
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, ObjectStatus, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
