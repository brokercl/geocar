      ...
      body: Column(
        children: [
          Row(
            ...
            children: [
              ElevatedButton(
                onPressed: () async => selectDate(context, controller.startDate,
                    DateTime(2024, 1), DateTime.now()),
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color.fromARGB(
                      255, 37, 81, 169), // Change the color here
                ),
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color.fromARGB(
                      255, 22, 157, 117), // Change the color here
                ),
